...
WHERE c.category_name = 'Sports & Outdoors'; -- can be any category name
...
FROM Users
LEFT JOIN Orders ON Users.user_id = Orders.user_id -- LEFT JOIN to include users with no orders
